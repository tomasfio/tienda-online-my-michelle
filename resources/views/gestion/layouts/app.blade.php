...
<head>
    ...
    <title>Gestion de tienda MyMichelle</title>
        ...
        <div class="wrapper">
            ...
            <nav class="main-header navbar navbar-expand navbar-white navbar-light">
                ...
                <form class="form-inline ml-3">
                    <div class="input-group input-group-sm">
                        <input class="form-control form-control-navbar" name="search" type="search" placeholder="Buscar..." aria-label="Buscar...">
            ...
            <aside class="main-sidebar sidebar-dark-primary elevation-4">
                ...
                <a href="{{ url('/') }}" class="brand-link">
                    <img src="{{ asset('dist/img/logo/logo.jpg')}}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
                        style="opacity: .8">
                    <span class="brand-text font-weight-light">Gestion My Michelle</span>
                </a>

                <!-- Sidebar -->
                <div class="sidebar">
                    <!-- Sidebar user panel (optional) -->
                    <div class="user-panel mt-3 pb-3 mb-3 d-flex">C
                        <div class="info">
